...
class PadMapDirtyInvalidationTest {
    @Test
    void detectsDirtyChunkTouchingSnapshot() {
    ...
    @Test
    void ignoresDirtyChunkOutsideSnapshot() {
        PadMapSnapshot snapshot = snapshot(0, 0, 4, 8, 8);
    ...
    @Test
    void mapsDirtyChunkToCellRange() {
    ...
    @Test
    void mapsNegativeDirtyChunkToCellRangeWithFloorDiv() {
    ...
    @Test
    void invalidatesOnlyDirtySnapshotCells() {
    ...
    @Test
    void invalidatesNegativeDirtySnapshotCells() {
    ...
    @Test
    void limitsWorkToDirtyIntersection() {
