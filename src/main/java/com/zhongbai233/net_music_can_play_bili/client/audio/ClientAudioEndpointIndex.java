...
public final class ClientAudioEndpointIndex {
    ...
    public static Set<UUID> geometricDemands(PlaybackSourceId sourceId) {
        ...
        return INDEX.audibleDemands(sourceId, minecraft.level.dimension().location().toString(),
                minecraft.player.getX(), minecraft.player.getEyeY(), minecraft.player.getZ());
    }
    ...
    public static Set<UUID> anticipatedDemands(PlaybackSourceId sourceId) {
        ...
        return INDEX.anticipatedDemands(sourceId, minecraft.level.dimension().location().toString(),
                minecraft.player.getX(), minecraft.player.getEyeY(), minecraft.player.getZ(),
