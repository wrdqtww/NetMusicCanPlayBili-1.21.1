...
abstract class VideoBillboardState {
    ...
    protected static final ResourceLocation TEXTURE_ID = ResourceLocation.fromNamespaceAndPath(
            NetMusicCanPlayBili.MODID, "dynamic/bili_video_preview");
    protected static final ResourceLocation YUV_TEXTURE_Y_ID = ResourceLocation.fromNamespaceAndPath(
            NetMusicCanPlayBili.MODID, "dynamic/bili_video_preview_y");
    protected static final ResourceLocation YUV_TEXTURE_U_ID = ResourceLocation.fromNamespaceAndPath(
            NetMusicCanPlayBili.MODID, "dynamic/bili_video_preview_u");
    protected static final ResourceLocation YUV_TEXTURE_V_ID = ResourceLocation.fromNamespaceAndPath(
    ...
    public record ProjectorFrameSnapshot(boolean hasFrame, boolean yuv, ResourceLocation rgbaTexture, ResourceLocation yTexture,
            ResourceLocation uTexture, ResourceLocation vTexture, Fmp4NativeVideoDecoder.DecodedFrame.Format format, int width,
