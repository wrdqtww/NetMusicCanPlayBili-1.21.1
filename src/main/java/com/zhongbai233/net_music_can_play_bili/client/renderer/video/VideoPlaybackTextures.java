...
final class VideoPlaybackTextures {
    ...
    VideoPlaybackTextures(String sessionId) {
        ...
        this.firstTextureId = ResourceLocation.fromNamespaceAndPath(NetMusicCanPlayBili.MODID,
                "dynamic/bili_video_preview_" + suffix + "_a");
        this.secondTextureId = ResourceLocation.fromNamespaceAndPath(NetMusicCanPlayBili.MODID,
                "dynamic/bili_video_preview_" + suffix + "_b");
        this.yTextureId = ResourceLocation.fromNamespaceAndPath(NetMusicCanPlayBili.MODID,
                "dynamic/bili_video_preview_" + suffix + "_y");
        this.uTextureId = ResourceLocation.fromNamespaceAndPath(NetMusicCanPlayBili.MODID,
                "dynamic/bili_video_preview_" + suffix + "_u");
        this.vTextureId = ResourceLocation.fromNamespaceAndPath(NetMusicCanPlayBili.MODID,
    ...
    private void ensureRgbaTextures(int width, int height) {
        ...
        release();
        frontTexture = new DynamicTexture(width, height, false);
        backTexture = new DynamicTexture(width, height, false);
    ...
    private void swapTextures() {
        ...
        ResourceLocation oldFrontId = frontTextureId;
