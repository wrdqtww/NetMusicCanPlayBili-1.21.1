...
final class PadMapLayerTexture implements AutoCloseable {
    ...
    private void ensureTexture() {
        ...
        texture = new DynamicTexture(TARGET_WIDTH, TARGET_HEIGHT, false);
    ...
    private void fill(NativeImage image, int x, int y, int w, int h, int color) {
        ...
        // 1.21.1 NativeImage.setPixelRGBA/fillRect 使用 ABGR 字节序；源常量是 ARGB 约定。
        image.fillRect(left, top, right - left, bottom - top, FastColor.ABGR32.fromArgb32(color));
    }
