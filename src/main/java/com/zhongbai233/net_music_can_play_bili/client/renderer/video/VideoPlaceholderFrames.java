...
final class VideoPlaceholderFrames {
    ...
    static ResourceLocation texture(Kind kind, long startedNanoTime) {
    ...
    private static ResourceLocation texture(String name) {
        return ResourceLocation.fromNamespaceAndPath(NetMusicCanPlayBili.MODID, "textures/gui/video_loading/" + name);
    }
