...
public interface HandheldArmRenderer {
    void renderMapHand(PoseStack poseStack, MultiBufferSource bufferSource, int light, HumanoidArm arm);

    void renderPlayerArm(PoseStack poseStack, MultiBufferSource bufferSource, int light, float equipProgress,
