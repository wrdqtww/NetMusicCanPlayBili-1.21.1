...
final class VideoPlaybackInstance {
    ...
    void submit(PortSubmitNodeCollector collector, Minecraft minecraft, Camera camera) {
        presentation.submit(collector, minecraft, camera);
    }
        ...
        minecraft.execute(() -> {
            ...
            Component retry = Component.literal("[重试视频]")
                    .withStyle(style -> style
                            ...
                            .withUnderlined(true)
                            .withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/ncpbc video retry"))
                            .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT,
                                    Component.literal("点击重新连接视频流"))));
