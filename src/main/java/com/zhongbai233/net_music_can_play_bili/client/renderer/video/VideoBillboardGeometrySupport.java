...
abstract class VideoBillboardGeometrySupport extends VideoBillboardQuadSupport {
    ...
    protected static void submitProjectorGeometry(PortSubmitNodeCollector collector, Minecraft minecraft,
            Camera camera, VideoProjectorBlockEntity projector) {
        submitProjectorGeometry(collector, minecraft, camera, projector, TEXTURE_ID, width, height);
    }

    static void submitProjectorGeometry(PortSubmitNodeCollector collector, Minecraft minecraft, Camera camera,
            VideoProjectorBlockEntity projector, ResourceLocation renderTextureId, int textureWidth,
            int textureHeight) {
        submitProjectorGeometry(collector, minecraft, camera, projector, renderTextureId, textureWidth, textureHeight,
                0.0D, YuvVideoRenderTypes.videoRgbaEntity(renderTextureId), "projector-rgba");
    }

    static void submitProjectorEmissiveGeometry(PortSubmitNodeCollector collector, Minecraft minecraft,
            Camera camera, VideoProjectorBlockEntity projector, ResourceLocation renderTextureId, int textureWidth,
            int textureHeight) {
        submitProjectorGeometry(collector, minecraft, camera, projector, renderTextureId, textureWidth, textureHeight,
                0.0D, shaderpackSafeEmissiveRgba(renderTextureId), "projector-rgba-placeholder");
    }

    static void submitProjectorPrivacyOverlay(PortSubmitNodeCollector collector, Minecraft minecraft, Camera camera,
            VideoProjectorBlockEntity projector) {
        PreviewQuad quad = computePreviewQuad(minecraft, camera, projector, 320, 180, true, true);
        if (quad == null) {
            return;
        }
    ...
    static void submitProjectorViewDepthOffsetGeometry(PortSubmitNodeCollector collector, Minecraft minecraft,
            Camera camera, VideoProjectorBlockEntity projector, ResourceLocation renderTextureId, int textureWidth,
    ...
    protected static void submitProjectorGeometry(PortSubmitNodeCollector collector, Minecraft minecraft,
            Camera camera, VideoProjectorBlockEntity projector, ResourceLocation renderTextureId, int textureWidth,
            int textureHeight, double viewDepthOffset, RenderType renderType, String route) {
    ...
    static void submitProjectorYuvGeometry(PortSubmitNodeCollector collector, Minecraft minecraft, Camera camera,
            VideoProjectorBlockEntity projector, VideoYuvTextureSet textures) {
        submitProjectorGeometry(collector, minecraft, camera, projector,
                yuvRenderTypeForCurrentIrisProgram(textures), textures.width(), textures.height());
    }
     ...
     * (for example a block carried by an entity renderer) can reuse the
     * already-correct BER pose stack.
     * </p>
     */
    ...
    protected static RenderType yuvRenderTypeForSnapshot(ProjectorFrameSnapshot frame) {
    ...
    protected static void submitProjectorGeometry(PortSubmitNodeCollector collector, Minecraft minecraft,
            Camera camera, VideoProjectorBlockEntity projector, RenderType renderType,
