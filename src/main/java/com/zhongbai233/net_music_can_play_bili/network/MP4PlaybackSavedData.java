...
public final class MP4PlaybackSavedData extends SavedData {
    ...
    public static final SavedData.Factory<MP4PlaybackSavedData> FACTORY = new SavedData.Factory<>(
            MP4PlaybackSavedData::new,
            MP4PlaybackSavedData::load);
    ...
    public CompoundTag save(CompoundTag tag, HolderLookup.Provider registries) {
        CODEC.encodeStart(NbtOps.INSTANCE, this)
                .resultOrPartial(error -> LOGGER.error("Failed to save mp4 playback data: {}", error))
                .ifPresent(encoded -> {
    ...
    private static MP4PlaybackSavedData load(CompoundTag tag, HolderLookup.Provider registries) {
