...
public final class PadDocumentSavedData extends SavedData {
    ...
    public static final SavedData.Factory<PadDocumentSavedData> FACTORY = new SavedData.Factory<>(
            PadDocumentSavedData::new,
            PadDocumentSavedData::load);
    ...
    public CompoundTag save(CompoundTag tag, HolderLookup.Provider registries) {
        CODEC.encodeStart(NbtOps.INSTANCE, this)
                .resultOrPartial(error -> LOGGER.error("Failed to save pad documents: {}", error))
                .ifPresent(encoded -> {
    ...
    private static PadDocumentSavedData load(CompoundTag tag, HolderLookup.Provider registries) {
