...
public final class ControlConsoleGuideScreen extends Screen {
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.drawString(font, Component.translatable("gui.net_music_can_play_bili.control_console.guide.line_1"),
                x + 28, y + 50, BlackGoldUi.TEXT_PRIMARY);
        graphics.drawString(font, Component.translatable("gui.net_music_can_play_bili.control_console.guide.line_2"),
                x + 28, y + 72, BlackGoldUi.TEXT_SECONDARY);
        graphics.drawString(font, Component.translatable("gui.net_music_can_play_bili.control_console.guide.line_3"),
                x + 28, y + 94, BlackGoldUi.TEXT_SECONDARY);
        graphics.drawString(font, Component.translatable("gui.net_music_can_play_bili.control_console.guide.line_4"),
                x + 28, y + 116, BlackGoldUi.TEXT_SECONDARY);
        graphics.drawString(font, Component.translatable("gui.net_music_can_play_bili.control_console.guide.line_5"),
