...
public class LyricProjectorScreen extends BlackGoldScreen {
    ...
    protected void onSave() {
        ...
        if (be != null && minecraft != null && minecraft.getConnection() != null) {
            PacketDistributor.sendToServer(new LyricProjectorConfigPacket(
                    blockPos,
    ...
    private void drawModeOverlay(GuiGraphics g) {
        ...
        g.drawCenteredString(font, Component.literal("\u25c8 " + modeBtn.currentOption()),
                x + w / 2, y + 5, GOLD);
    }
    ...
    private void drawAiOverlay(GuiGraphics g) {
        ...
        g.fillGradient(x, y, x + w, y + h, GOLD & 0x30FFFFFF, GOLD & 0x18FFFFFF);
        g.drawCenteredString(font, Component.literal("\u25c8 " + aiBtn.currentOption()),
                x + w / 2, y + 5, GOLD);
    }
}
