...
public class SpeakerScreen extends BlackGoldScreen {
    ...
    protected void onSave() {
        ...
        if (be != null && minecraft != null && minecraft.getConnection() != null) {
            PacketDistributor.sendToServer(new SpeakerConfigPacket(blockPos, channelIndex, volume, autoMixJoc));
    ...
    protected void drawContent(GuiGraphics g, int bx, int by, int mx, int my) {
        int cx = bx + BOX_W / 2;
        g.drawCenteredString(font, Component.literal("\u58f0\u9053\u9009\u62e9 7.1.4"), cx, by + HEADER_H + 2,
                TEXT_SECONDARY);
        SpeakerBlockEntity be = getSpeakerBE();
        if (be != null) {
            ...
            String info = linked != null
                    ...
                    : "\u672a\u8fde\u63a5";
            g.drawCenteredString(font, Component.literal(info), cx, by + BOX_H - 20, linked != null ? GOLD : TEXT_DIM);
        }
    }
}
