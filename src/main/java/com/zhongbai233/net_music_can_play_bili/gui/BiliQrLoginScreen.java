...
public class BiliQrLoginScreen extends Screen {
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.drawCenteredString(this.font, "B站账号登录", boxX + BOX_WIDTH / 2, boxY + 10, 0xFFFFFFFF);
        ...
        if (qrTextureId != null) {
            ...
            graphics.blit(qrTextureId, qrX, qrY, 0, 0, QR_SIZE, QR_SIZE,
                    Math.max(1, qrTextureWidth), Math.max(1, qrTextureHeight));
        } else {
            graphics.fillGradient(qrX, qrY, qrX + QR_SIZE, qrY + QR_SIZE, 0xFF444444, 0xFF444444);
        }

        int statusColor = done ? 0xFF55FF55 : 0xFFAAAAAA;
        graphics.drawCenteredString(this.font, statusText, boxX + BOX_WIDTH / 2, boxY + BOX_HEIGHT - 16, statusColor);
    }
