...
public class VideoProjectorBlockEntity extends SyncedBlockEntity {
    ...
    protected void loadAdditional(CompoundTag input, HolderLookup.Provider registries) {
        ...
        this.projectionHeight = getFloatOr(input, PROJ_HEIGHT, 1.8F);
        ...
        this.projectionBrightness = VideoSurfaceBrightness.normalize(
                getFloatOr(input, PROJ_BRIGHTNESS, VideoSurfaceBrightness.DEFAULT));
        this.preferredQuality = getIntOr(input, PREFERRED_QUALITY, DEFAULT_PREFERRED_QUALITY);
        refreshClientLinkRegistration();
