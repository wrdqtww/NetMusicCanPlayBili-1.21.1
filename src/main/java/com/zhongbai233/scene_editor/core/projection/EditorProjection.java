...
public final class EditorProjection {
    ...
    public static Vector3d worldPointAtScreenDepth(double screenX, double screenY, double depth,
            CameraMatrices matrices, EditorViewport viewport) {
        ...
        double ndcX = ((screenX - viewport.x()) / viewport.width()) * 2.0D - 1.0D;
        double ndcY = 1.0D - ((screenY - viewport.y()) / viewport.height()) * 2.0D;
