...
public final class CommandStack<S> {
    ...
    public S execute(S state, EditorCommand<S> command) {
        EditorCommand<S> required = java.util.Objects.requireNonNull(command, "command");
        S result = java.util.Objects.requireNonNull(required.apply(state), "command result");
    ...
    public S undo(S state) {
        ...
        S result = java.util.Objects.requireNonNull(command.undo(state), "undo result");
    ...
    public S redo(S state) {
        ...
        S result = java.util.Objects.requireNonNull(command.apply(state), "redo result");
